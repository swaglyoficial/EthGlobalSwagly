    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-h-[90vh] w-[95vw] max-w-2xl overflow-y-auto border-[#5061EC]/30 bg-gradient-to-br from-black via-[#5061EC]/5 to-black p-0 text-white backdrop-blur-xl">
        ...
        <div className="space-y-4 p-4 sm:p-6">
          ...
          {/* Scan Merch Button - Solo si NO está completada y NO requiere validación manual */}
          {!isCompleted && !isApproved && !isPending && (
            <div className="rounded-xl border border-[#5061EC]/30 bg-gradient-to-br from-[#5061EC]/10 to-transparent p-4">
              ...
              <p className="mb-3 text-xs text-white/70 sm:text-sm">
                Acerca tu dispositivo al tag NFC o escanea el código QR en el stand de la actividad
              </p>
              <Button
                onClick={() => setShowScanDialog(true)}
                className="w-full rounded-full bg-gradient-to-r from-[#FEE887] to-[#FFFACD] text-black font-bold text-sm shadow-2xl shadow-[#FEE887]/40 transition-all duration-300 hover:scale-105 hover:shadow-[#FEE887]/60 sm:text-base"
                size="lg"
              >
